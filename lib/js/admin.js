jQuery(document).ready(function($) {    
	...
	$( '#vat-country' ).live( 'change', function( event ) {
		$( '#vat-number-country-code' ).val( $( this ).val() );
	});
	
	$( '.it-exchange-easy-eu-value-added-taxes-addon-delete-tax-rate' ).live( 'click', function( event ) {
		event.preventDefault();
	...
	$( '.block-column-default' ).live( 'click', function( event ) {
		event.preventDefault();
		$( '.it-exchange-easy-eu-value-added-taxes-addon-default-checkmark' ).removeClass( 'it-exchange-easy-eu-value-added-taxes-addon-default-checkmark-checked' );
		$( '.it-exchange-easy-eu-value-added-taxes-addon-default-checkmark' ).val( 'unchecked' );
